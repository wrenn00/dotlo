...
const colorMap = [
  // 이전에 sky-blue로 베이크된 색 → navy/lavender로 재교체
  { name: "sky-blue (#00E1FF) → navy (#2E2E70)",     from: [0.0, 0.882353, 1.0], to: [0.180392, 0.180392, 0.439216] },
  { name: "옅은 sky-blue (#C2F5FF) → 옅은 lavender (#EFEFFF)", from: [0.760784, 0.960784, 1.0], to: [0.937255, 0.937255, 1.0] },
  // 원본 초록 색상도 보존 (혹시 덜 베이크된 영역 대비)
  { name: "메인 초록 → navy (#2E2E70)",      from: [0.172549, 0.854902, 0.580392], to: [0.180392, 0.180392, 0.439216] },
  { name: "연초록 링 → 옅은 lavender (#EFEFFF)", from: [0.783505, 0.945098, 0.880089], to: [0.937255, 0.937255, 1.0] },
