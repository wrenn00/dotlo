...
export default function Step2LoadingPage() {
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(180deg, #E6FAF8 0%, #ffffff 60%)",
      }}
    >
      {/* 뒤로가기 */}
      ...
      <div className="flex flex-col flex-1 items-center justify-center gap-6 px-8">
        ...
        <div className="relative flex items-center justify-center" style={{ width: 110, height: 110 }}>
          ...
          >
            <circle cx="55" cy="55" r="50" fill="none" stroke="#E2FBF3" strokeWidth="6" />
            <circle
              cx="55" cy="55" r="50"
              fill="none"
              stroke="#38C6AF"
          ...
          >
            <svg width="32" height="38" viewBox="0 0 32 38" fill="none">
              <path d="M16 2C9.37 2 4 7.37 4 14c0 9.63 12 24 12 24s12-14.37 12-24C28 7.37 22.63 2 16 2z" fill="#38C6AF" />
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <p style={{ fontSize: 14, color: "#9CA3AF", textAlign: "center", lineHeight: "22px" }}>
            잠시만 기다려주세요{"\n"}최대 30초 정도 걸려요
          </p>
        </div>
        ...
        >
          <div className="w-2 h-2 rounded-full" style={{ background: "#38C6AF" }} />
          <span style={{ fontSize: 14, fontWeight: 600, color: "#38C6AF" }}>
            {count}개 장소 가져옴
          </span>
        </div>
      </div>
